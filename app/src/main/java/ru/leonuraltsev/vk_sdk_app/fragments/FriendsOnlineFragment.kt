...
import ru.leonuraltsev.vk_sdk_app.presenters.FriendsOnlineFragmentPresenter
import ru.leonuraltsev.vk_sdk_app.views.FriendsFragmentView

class FriendsOnlineFragment : MvpAppCompatFragment(), FriendsFragmentView {
    ...
    @InjectPresenter
    lateinit var friendsFragmentOnlineFragment: FriendsOnlineFragmentPresenter
    companion object{

        fun getInstance() : FriendsOnlineFragment{
            val args = Bundle()
            val fragment = FriendsOnlineFragment()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        friendsFragmentOnlineFragment.loadFriends()
    ...
    override fun setupFriendsList(friendsList: ArrayList<VKUser>) {
        ...
        tvFriendsNoItem.visibility = View.GONE
        mAdapter.setupOnlineFriends(friendsList = friendsList)
    }
